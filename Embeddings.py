...
# MAGIC %sql
# MAGIC drop table rag_pdfsdocs_text

# COMMAND ----------

# MAGIC %sql
# MAGIC create table if not exists rag_pdfsdocs_text ( id BIGINT generated by default as identity, text STRING ) tblproperties(delta.enableChangeDataFeed=true);

# COMMAND ----------

# MAGIC %sql
# MAGIC create table if not exists rag_pdfs_docs_track ( file_name STRING ) tblproperties(delta.enableChangeDataFeed=true);
